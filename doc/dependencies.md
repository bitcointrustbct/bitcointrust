...
These are the dependencies currently used by Bitcointrust. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/bitcointrustnl
Keybase  - https://keybase.io/team/bitcointrust/
