...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"bitcointrustaddress\"\n"
            "\nReveals the private key corresponding to 'bitcointrustaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"bitcointrustaddress\"   (string, required) The bitcointrust address for the private key\n"
            "\nResult:\n"
