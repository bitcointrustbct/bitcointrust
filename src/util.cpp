...
const char * const BITCOIN_CONF_FILENAME = "bitcointrust.conf";
const char * const BITCOIN_PID_FILENAME = "bitcointrustd.pid";
...
#else
    const char* pszModule = "bitcointrust";
#endif
    if (pex)
        return strprintf(
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcointrust";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitcointrust";
#else
    // Unix
    return pathRet / ".bitcointrust";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    std::string strCopyrightHolders =
        ...
        "\n" + strPrefix + "Bitcointrust developers";
