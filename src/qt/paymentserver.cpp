...
const QString BITCOIN_IPC_PREFIX("bitcointrust:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bitcointrust-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitcointrust-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitcointrust-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bitcointrust: links
...
//
// OSX-specific way of handling bitcointrust: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bitcointrust: URIs
