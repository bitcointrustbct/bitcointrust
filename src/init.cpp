...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcointrustbct/bitcointrust>";
    const std::string URL_WEBSITE = "<https://bitcointrust.global/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Bitcointrust Developers", 2022)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Bitcointrust useful. "
