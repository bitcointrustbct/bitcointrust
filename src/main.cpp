...
#if defined(NDEBUG)
# error "Bitcointrust cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitcointrust Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Bitcointrust also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Bitcointrust also requires low S in sigs
